...
def test_single(test_file, loaded_model, iou_object):
...
if __name__ == '__main__':
    ...
    test_miou = iouEval(tr_dict['num_classes'], class_ignore)
    ...
    test_single(test_file, loaded_model, test_miou)
